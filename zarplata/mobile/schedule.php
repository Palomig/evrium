...
/* Недельная таблица в духе Google Sheets (единственный стиль) */
...
function setScheduleDesign() {
    // Единственный стиль недели — бывший «Вариант 2» (таблица в духе Google Sheets)
    document.body.classList.add('schedule-design-2');
