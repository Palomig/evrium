...
### 1. Веб-интерфейс на странице "Тесты" (рекомендуется) ⭐

Откройте в браузере:

```
https://эвриум.рф/zarplata/tests.php
```

**Где находится:**
- Войдите в систему Zarplata
- Перейдите в раздел "Тесты" (в боковом меню)
- Найдите секцию "Синхронизация количества студентов"
- Нажмите кнопку "Синхронизировать количество студентов"

**Преимущества:**
- ✅ Не требует SSH-доступа
- ✅ Интегрирована в систему тестирования
