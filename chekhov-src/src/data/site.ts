...
export const site = {
  ...
  centerBio: 'Репетиторский центр в Чехове. Готовим школьников 5–11 классов к ОГЭ, ЕГЭ, контрольным и помогаем закрыть пробелы. Очные занятия в нашем кабинете на ул. Московская, 87/1.',
