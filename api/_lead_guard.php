...
/**
 * Редакция документа «Согласие на обработку персональных данных»
 * (/soglasie-na-obrabotku-personalnyh-dannyh/). Пишется в журнал заявок:
 * при споре видно, с каким именно текстом человек согласился.
 * Меняете текст согласия — поднимайте дату здесь.
 */
const LEAD_CONSENT_VERSION = 'soglasie-2026-08-11';
